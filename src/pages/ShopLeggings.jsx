        ...
        <div className="header__container">
          <div className="shop__content--upper">
            <div>
              ...
              <h1 className="shop--upper__title">LEGGINGS</h1>
            </div>
          </div>
          ...
          <div className="filter__menu">
            ...
            <Link className="categories__link link__inactive" to="/">
          ...
          <div className="shop__categories">
            ...
            <Link className="categories__link " to="/shop-leggings">
          ...
          <div className="ads__container">
            {ads
             .filter(ads => ads.specific === "leggings")
            .map((ads) => (
